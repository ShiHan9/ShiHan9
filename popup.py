...
while True:
    ...
    if results:
        ...
        # If the detected emotion is 'sad' with the highest score, display a motivational quote
        if highest_confidence_result['label'] == 'sad':
            quote = get_motivational_quote()
            print(f"Displaying motivational quote: {quote}")
            cv2.putText(frame, quote, (50, 100), font, font_scale, (0, 215, 255), thickness)
